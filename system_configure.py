...
avUserLoad  = 28      # average traffic usage per second in bits/ 2轻负载，8重负载, 20593*8 is the total gs traffic in bits/s, so 20593*8/3 is the average traffic per user in bits/s when balancedFlow is False
...
#   ]
trafficPairs = [
    ("Malaga, Spain",                  "Aalborg, Denmark",  700e6),   # 1 Gbps  Malaga → LA
    ("Los Angeles, California, US",    "Panama",            700e6),   # 800 Mbps LA → Panama
