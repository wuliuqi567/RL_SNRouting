...
class MHGNNDDQNLearner(BaseLearner):
    def __init__(self, config: Namespace, policy: Module):
        ...
        self.scheduler = torch.optim.lr_scheduler.LinearLR(self.optimizer, start_factor=1.0, end_factor=0.0, total_iters=config.lr_decay_steps)
        ...
        if config.pd_loss == "MSE":
            ...
            raise AttributeError("No pd_loss is implemented.")
